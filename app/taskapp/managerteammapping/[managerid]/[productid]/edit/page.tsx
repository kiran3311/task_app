...
function EditTeamMappingPage({ params }: { params: { managerid: number, productid: number } }) {
            ...
            <div className='flex flex-col w-full mt-5 ml-3'>
               ...
               itemClasses={{
                   ...
                   separator: "text-white",
                    ...
                    <BreadcrumbItem onClick={() => router.push("/taskapp/managerteammapping/createmapping")} >Edit Team Mapping</BreadcrumbItem>
                </Breadcrumbs>
                <h2 className='font-bold text-xl mt-4'>Edit Manager Team Mapping</h2>
                ...
                <div className='mt-4'>
                    <button onClick={handleCreateMapping} className='bg-red-500 text-white px-3 py-1 rounded'>Create  Client</button>
                </div>
            </div>
        </div>
    )
...
export default EditTeamMappingPage